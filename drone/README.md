...
to the Pixhawk autopilot). The browser UI that an operator looks at lives in
[../groundstation/](../groundstation/) and is mounted by the dashboard backend
here so a browser pointed straight at the Pi gets the same page.
